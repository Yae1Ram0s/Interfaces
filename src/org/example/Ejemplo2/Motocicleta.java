...
public class Motocicleta implements Vehiculo{
    ...
    public void hacerCaballito(){
        System.out.println("Haciendo caballito para pegarse");
    }

    @Override
    public boolean encender() {
        System.out.println("Encendiendo con la motocicleta marca" + this.marca);
        return true;
    }
    ...
    @Override
    public void avanzar() {
        System.out.println("Avanzando con la motocicleta de" + this.centimetrosCubicos  );

    }

    @Override
    public void frenar() {
        System.out.println("Frenando con la motocicleta de" + this.centimetrosCubicos  );
